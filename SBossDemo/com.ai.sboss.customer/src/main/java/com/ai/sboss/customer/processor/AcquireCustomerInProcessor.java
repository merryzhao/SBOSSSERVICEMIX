 ...
 *
 */
public class AcquireCustomerInProcessor implements IBasicInProcessor{

	private static final String HUB_FORMAT_QUERY = "servicecode=acquireCustomer&WEB_HUB_PARAMS={\"data\":<PARAM_JSON>,\"header\":{\"Content-Type\":\"application/json\"}}";
	...
	public JSONObject getInputParam(Exchange exchange) throws Exception {
		...
		if (role_type == 1){
			ret.put("customerId", input.getLong("user_id"));
		}
		return ret;
	}
