...
public class GetServiceTopicTotalAggregation implements AggregationStrategy {
	private Logger logger = Logger.getLogger(GetServiceTopicTotalAggregation.class);
	@Override
	public Exchange aggregate(Exchange oldExchange, Exchange newExchange) {
		logger.info("==GetServiceTopicTotalAggregation==");
