...
public class QueryOfferingListInProcessor implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		String query = FORMAT_QUERY.replace("<ID>", param.getString("catalog_id")).replace("<PS>", param.getString("page_size")).replace("<PN>", param.getString("page_num"));
