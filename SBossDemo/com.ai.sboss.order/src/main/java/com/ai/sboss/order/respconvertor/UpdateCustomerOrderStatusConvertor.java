...
@Component("updateCustomerOrderStatusConvertor")
public class UpdateCustomerOrderStatusConvertor implements IBasicOutProcessor {
	private static final Log LOGGER = LogFactory.getLog(UpdateCustomerOrderStatusConvertor.class);
