...
@Component("changeOrderStateToDisableConvertor")
public class ChangeOrderStateToDisableConvertor implements IBasicOutProcessor {

	private final static Log LOGGER = LogFactory
			.getLog(ChangeOrderStateToDisableConvertor.class);
	...
	public String convert2requst(String data) throws Exception {
		...
		retValue.put("result", crmJsonObject.get("data"));
