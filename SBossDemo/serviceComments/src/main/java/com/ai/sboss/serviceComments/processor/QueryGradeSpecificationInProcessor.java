...
public class QueryGradeSpecificationInProcessor implements IBasicInProcessor {

	private static Logger LOGGER = Logger
			.getLogger(QueryGradeSpecificationInProcessor.class.getName());

	private static final String HUB_FORMAT_URL = "servicecode=queryGradeSpecification&WEB_HUB_PARAMS={\"data\":<PARAM_JSON>,\"header\":{\"Content-Type\":\"application/json\"}}";
