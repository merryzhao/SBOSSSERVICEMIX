...
public class SaveCommentsOutProcessor implements IBasicOutProcessor {
	
	private static Logger LOGGER = Logger.getLogger(SaveCommentsOutProcessor.class.getName());
