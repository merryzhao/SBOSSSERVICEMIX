...
public class QueryCommentTagsInProcessor implements IBasicInProcessor {

	private static Logger LOGGER = Logger
			.getLogger(QueryCommentTagsInProcessor.class.getName());

	private static final String HUB_FORMAT_URL = "servicecode=queryCommentTags&WEB_HUB_PARAMS={\"data\":<PARAM_JSON>,\"header\":{\"Content-Type\":\"application/json\"}}";
