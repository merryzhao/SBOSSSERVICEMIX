...
public class QueryCommentsForPartyRoleInProcessor implements IBasicInProcessor {

	private static Logger LOGGER = Logger
			.getLogger(QueryCommentsForPartyRoleInProcessor.class.getName());

	private static final String HUB_FORMAT_URL = "servicecode=queryCommentsForPartyRole&WEB_HUB_PARAMS={\"data\":<PARAM_JSON>,\"header\":{\"Content-Type\":\"application/json\"}}";
