...
public class QueryCommentsForServiceDetailInProcessor implements
		IBasicInProcessor {

	private static Logger LOGGER = Logger
			.getLogger(QueryCommentsForServiceDetailInProcessor.class.getName());

	private static final String HUB_FORMAT_URL = "servicecode=queryCommentsForServiceDetail&WEB_HUB_PARAMS={\"data\":<PARAM_JSON>,\"header\":{\"Content-Type\":\"application/json\"}}";
