...
public class SaveCommentsInProcessor implements IBasicInProcessor {

	private static Logger LOGGER = Logger
			.getLogger(SaveCommentsInProcessor.class.getName());

	private static final String HUB_FORMAT_URL = "servicecode=addComments&WEB_HUB_PARAMS={\"data\":<PARAM_JSON>,\"header\":{\"Content-Type\":\"application/json\"}}";
