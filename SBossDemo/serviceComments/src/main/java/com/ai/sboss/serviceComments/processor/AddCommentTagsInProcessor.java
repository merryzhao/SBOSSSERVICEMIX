...
public class AddCommentTagsInProcessor implements IBasicInProcessor {

	private static Logger LOGGER = Logger
			.getLogger(AddCommentTagsInProcessor.class.getName());

	private static final String HUB_FORMAT_URL = "servicecode=addCommentTags&WEB_HUB_PARAMS={\"data\":<PARAM_JSON>,\"header\":{\"Content-Type\":\"application/json\"}}";
