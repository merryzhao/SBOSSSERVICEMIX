...
public class QuerySysGradeSpecificationInProcessor implements IBasicInProcessor {

	private static Logger LOGGER = Logger
			.getLogger(QuerySysGradeSpecificationInProcessor.class.getName());

	private static final String HUB_FORMAT_URL = "servicecode=querySysGradeSpecification&WEB_HUB_PARAMS={\"data\":<PARAM_JSON>,\"header\":{\"Content-Type\":\"application/json\"}}";
