...
@Component("getProcessScriptConvertor")
public class GetProcessScriptConvertor implements IBasicOutProcessor {

	private static final Logger LOGGER = Logger
			.getLogger(GetProcessScriptConvertor.class);

	private final static String RESULT_FMT = "{\"data\":<DATA>,\"desc\":{\"result_code\":<RET_CODE>,\"result_msg\":\"<RET_MSG>\",\"data_mode\":\"0\",\"digest\":\"\"}}";

	@Autowired
	@Qualifier(value = "processScriptParameter")
	private IScriptParameter processScriptParameter;
	...
	public String convert2requst(String data) throws Exception {
		...
		if (!StringUtils.isEmpty(data)) {
			...
			// Get script value
			scriptRetValue = processScriptParameter
