 ...
 *
 */
@Component("queryArrangementInstancesByidWithSetProcessor")
public class QueryArrangementInstancesByidWithSetProcessor implements IBasicInProcessor {

	/**
	 * 日志
	 */
	private static final Log LOGGER = LogFactory.getLog(QueryArrangementInstancesByidWithSetProcessor.class);
	...
	public void process(Exchange exchange) throws Exception {
        ...
        try {
            ...
            arrangementinstanceid = httpDateParams.getString("arrangementinstanceid");
            LOGGER.info("========得到参数：" + httpDateParams.toString());
        } catch(BizException e) {
            QueryArrangementInstancesByidWithSetProcessor.LOGGER.error(e.getMessage(), e);
        ...
        if(jsonEntity == null) {
            jsonEntity = this.queryOps.queryArrangementInstanceByArrangementInstanceIDWithSet(arrangementinstanceid);
