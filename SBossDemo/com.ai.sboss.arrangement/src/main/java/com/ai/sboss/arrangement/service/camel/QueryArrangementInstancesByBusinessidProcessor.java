 ...
 *
 */
@Component("queryArrangementInstancesByBusinessidProcessor")
public class QueryArrangementInstancesByBusinessidProcessor implements IBasicInProcessor {

	/**
	 * 日志
	 */
	private static final Log LOGGER = LogFactory.getLog(QueryArrangementInstancesByBusinessidProcessor.class);
	...
	public void process(Exchange exchange) throws Exception {
        ...
        try {
            ...
            QueryArrangementInstancesByBusinessidProcessor.LOGGER.error(e.getMessage(), e);
