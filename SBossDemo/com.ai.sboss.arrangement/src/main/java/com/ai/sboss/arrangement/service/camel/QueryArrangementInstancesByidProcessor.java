 ...
 *
 */
@Component("queryArrangementInstancesByidProcessor")
public class QueryArrangementInstancesByidProcessor implements IBasicInProcessor {

	/**
	 * 日志
	 */
	private static final Log LOGGER = LogFactory.getLog(QueryArrangementInstancesByidProcessor.class);
	...
	public void process(Exchange exchange) throws Exception {
		...
		try {
			...
			QueryArrangementInstancesByidProcessor.LOGGER.error(e.getMessage(), e);
		...
		if(jsonEntity == null) {
			jsonEntity = this.queryOps.queryArrangementInstanceByArrangementInstanceID(arrangementinstanceid);
