 ...
 * @author yinwenjie
 */
@Component("queryJointByBusinessIDProcessor")
public class QueryJointByBusinessIDProcessor implements IBasicInProcessor {
	
	/**
	 * 日志
	 */
	private static final Log LOGGER = LogFactory.getLog(QueryJointByBusinessIDProcessor.class);
	...
	public void process(Exchange exchange) throws Exception {
		...
		//2、================
		if(jsonEntity == null) {
			jsonEntity = this.queryOps.queryJointBybusinessID(businessid);
