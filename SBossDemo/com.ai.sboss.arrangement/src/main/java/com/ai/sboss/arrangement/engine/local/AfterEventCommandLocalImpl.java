...
import com.ai.sboss.arrangement.engine.IAfterEventCommand;
 ...
 * @author yinwenjie
 */
@Component("_processorEngine_afterEventCommand")
public class AfterEventCommandLocalImpl implements IAfterEventCommand {
	...
	public void execute() throws BizException {
		...
		flowEvent.setArrangementInstanceId(arrangementInstanceId);
		//absOffsettime
		...
		//jointInstanceId
		flowEvent.setJointInstanceId(jointInstanceId);
		//expandTypeId
	...
	public void undo() throws BizException {
		...
		//arrangementuid
		String arrangementuid = arrangementInstanceObject.getString("uid");
