...
/**
 * 和“任务”相关的持久层数据服务，通过这个接口被调用
 * @author yinwenjie
 */
public interface IJointDAO extends SystemDAO<JointEntity> {
	/**
	 * 按照行业编号，查询这个行业下，已经定义的任务信息。<br>
	 * 排序会按照任务编号进行，并且不带分页。且只包括基本信息，不包括inputparams集合、outputparams集合、trade集合信息
	 ...
	 * 排序会按照任务编号进行，带分页。且只包括基本信息，不包括inputparams集合、outputparams集合、trade集合信息
	...
	/**
	 * 按照“显示名称”精确查询相匹配的任务信息。且只包括基本信息，不包括inputparams集合、outputparams集合、trade集合信息
	 * @param displayName 精确查询的“显示名称”
	 * @return 
	 * @throws BizException 
	 */
	...
	/**
	 * 按照“显示名称”精确查询相匹配的任务信息。且包括inputparams集合、outputparams集合、trade集合信息
	 * @param displayName 精确查询的“显示名称”
	 * @return 
	 * @throws BizException 
	 */
	 ...
	 * 另外，joint的uid唯一编号信息不需要指定。若没有填写uid，系统将为这个joint任务生成一个全系统唯一的<br>
	 * 其他参数根据业务的实际情况来
	 * @param joint 
	 * @throws BizException 
	 */
	 ...
	 * 删除joint任务的行业信息。<br>
	 * 注意，相关mapping信息都会删除
	 * @param jointuid 需要删除的指定的任务唯一编号信息
	 * @throws BizException 
	 */
