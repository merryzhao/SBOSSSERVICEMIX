 ...
 *
 */
public class ExceptionEvent extends ArrangementEvent {

	/**
	 * 
	 */
	private static final long serialVersionUID = 655226736288076647L;
	...
	/**
	 * @param exceptionMess the exceptionMess to set
	 */
