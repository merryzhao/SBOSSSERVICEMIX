...
/**
 * “业务流程正常结束流转”事件发送器的一个本地实现<br>
 * 将事件通知发送到本地的一个 事件“生产者-消费者”模型中
 * @author yinwenjie
 */
public class ArrangementEndEventLocalSender implements ArrangementEndEventSender {

	/* (non-Javadoc)
	 * @see com.ai.sboss.arrangement.event.ArrangementEndEventSender#senderEndEvent(com.ai.sboss.arrangement.event.EndEvent)
	 * @see com.ai.sboss.arrangement.event.local.ArrangementBeginEventLocalSender#senderBeginEvent(BeginEvent event) throws BizException
	 */
	@Override
