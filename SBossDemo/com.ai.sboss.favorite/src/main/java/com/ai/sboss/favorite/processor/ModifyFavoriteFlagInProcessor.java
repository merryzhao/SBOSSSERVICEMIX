...
public class ModifyFavoriteFlagInProcessor implements IBasicInProcessor {
	protected Logger logger = Logger.getLogger(this.getClass());
	private static final String HUB_FORMAT_QUERY = "servicecode=modifyFavoriteFlag&WEB_HUB_PARAMS={\"data\":<PARAM_JSON>,\"header\":{\"Content-Type\":\"application/json\"}}";
	@Override
	...
	public JSONObject getInputParam(Exchange exchange) {
		...
		returnParam.put("favoriteEntryId", ret.getString("favorite_id"));
		returnParam.put("favoriteFlag",  ret.getString("content_favorite_flag"));
		return returnParam;
	}
}
