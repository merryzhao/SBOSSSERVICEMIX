...
public class FavoriteOriginsConvertOutProcessor implements IBasicOutProcessor {
	...
	public String convert2requst(String data) {
		...
		for(int originIdx = 0; originIdx < originsList.size(); originIdx ++){
			...
			obj.put("origin_name", originsList.get(originIdx).toString());
		...
		returnJson.put("content_origins", originsListForFront.toString());
